...
export type ChatState = {
  ...
  /** Captured from agent events during streaming: assistant media URLs to inject into final message. */
  chatStreamMediaUrls: string[] | null;
  /** Per-runId media URLs fallback, keyed by runId, for late-arriving terminal events. */
  lastChatStreamMediaUrls: Record<string, string[] | undefined> | null;
